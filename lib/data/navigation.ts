...
// Navigation items for /works page
export const worksPageNavigationItems: NavigationItem[] = [
  {
    command: '/ Main',
    route: '/main',
    description: '/ Hero Section: «The Story of How We\'ll Work Together»',
...
// Navigation items for /info-contact page
export const infoContactPageNavigationItems: NavigationItem[] = [
  {
    command: '/ Main',
    route: '/main',
    description: '/ Hero Section: «The Story of How We\'ll Work Together»',
