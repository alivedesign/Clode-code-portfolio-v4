...
export default function Works() {
  ...
  return (
    <div className="bg-background min-h-screen flex flex-col items-center px-spacing-7 mobile:px-spacing-9 tablet:px-[32px] desktop:px-[40px] py-spacing-8 relative">
        ...
        <div className="flex flex-col gap-spacing-9 flex-1">
          ...
          <div className="flex flex-col gap-spacing-8">
            ...
            {projects.map((project) => {
              const isClickable = project.slug && !project.isNDA;
              const cardContent = (
                <>
                  {/* Project Image */}
                  <div className="relative w-full aspect-[795/454] rounded-[6px] overflow-hidden">
                    ...
                    {/* Coming soon overlay for mobile/tablet (non-NDA projects without slug) */}
              ...
              // If clickable, wrap in Link; otherwise wrap in div with cursor logic
              if (isClickable) {
                return (
                  <Link
                    key={project.id}
      ...
      {/* Custom Cursor - Desktop only (for non-NDA projects without slug) */}
      {showCursor && (
        <div
